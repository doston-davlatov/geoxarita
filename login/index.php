...
<div class="form-container">
    ...
    <form method="post" action="">
        ...
        <div class="form-group">
            <button type="submit" name="submit" id="submit" disabled>Kirish</button>
        </div>
    </form>
...
<script>
    ...
    function validateForm() {
        ...
        if (!usernamePattern.test(username)) {
            usernameError.textContent = "Foydalanuvchi nomi faqat harflar, raqamlar va pastki chiziqlardan iborat bo'lishi mumkin!";
