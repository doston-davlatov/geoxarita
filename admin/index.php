...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-main-buttons mb-3">
            <li>
                ...
                <a href="./creat_mfy.php" class="nav-link">
                    <i class="fa-solid fa-database"></i>
                    <span>Mahalla yaratish</span>
                </a>
                <a href="./edit_mfy.php" class="nav-link">
                    <i class="fa-solid fa-database"></i>
                    <span>Mahallani tahrirlash</span>
                </a>
            </li>
        </div>
    ...
    <main>
        ...
        <p>Mahallalar bo‘yicha Oilaviy nizolarni interaktiv xaritada kuzating</p>
        <div id="map"></div>
    </main>
            ...
            fetch(`../connection/get_mahallalar.php?tuman_id=${tuman_id}`)
                ...
                .then(data => {
                    ...
                    mahallalar.forEach(mahalla => {
                        ...
                        btn.onclick = () => {
                            window.location.href = `view_nizo.php?id=${mahalla.id}`;
                        };
